    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            for (int i = 0; i < x.Length; i++)
                Console.WriteLine("x{0} = {1:0.00}", i, x[i]);
            ...
            for (int i = 0; i < x.Length; i++)
                Console.WriteLine("x*{0} = {1:0.00}", i, x1[i]);
            ...
            Console.Write("\n||x|| = {0}\n ", VectorNorm(x));
            Console.Write("\n||x*|| = {0}\n ", VectorNorm(newx));
            Console.Write("\n||x|| / ||x*|| = {0}", VectorNorm(x) / VectorNorm(newx));

            double d = (A.Norm / invertA.Norm) / (1 - A.Norm / invertA.Norm * newA.Norm / A.Norm) *
                       (VectorNorm(newb) / VectorNorm(b) + newA.Norm / A.Norm);
            Console.WriteLine("\n\nОценка = {0}", d);
            Console.ReadLine();
